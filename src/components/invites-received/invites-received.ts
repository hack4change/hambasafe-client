...
/*
  Generated class for the InvitesReceived component.

  See https://angular.io/docs/ts/latest/api/core/index/ComponentMetadata-class.html
  for more info on Angular 2 Components.
*/
@Component({
  selector: 'invites-received',
  templateUrl: 'invites-received.html'
})
export class InvitesReceived implements OnInit {
